;;; compilation.el --- compilation-mode set up -*-coding:utf-8-*-
...
;; Set up for compilation-mode, that is usually the mode of the output
;; buffer generated by issuing `M-x compile`.

;;; Code:

;; Make compilation-mode understand ANSI colors in output <slu@rabota>
