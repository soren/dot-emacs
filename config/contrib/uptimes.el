;;; uptimes.el --- uptime tracking -*-coding:utf-8-*-
...
;; Uptime tracking for Emacs.

;; See https://github.com/davep/uptimes.el

;;; Code:

(unless (package-installed-p 'uptimes)
  (package-install 'uptimes))
